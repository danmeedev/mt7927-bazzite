...
echo ""
echo "=========================================="
echo "FULL DMESG OUTPUT (all mt7927 lines):"
echo "=========================================="
dmesg | grep -E "mt7927|MT7927"

echo ""
echo "=========================================="
echo "REGISTER DUMPS (hex values):"
echo "=========================================="
dmesg | grep -E 'mt7927.*0x'

echo ""
echo "=========================================="
echo "IOMMU/DMA ERRORS (if any):"
echo "=========================================="
dmesg | grep -E 'AMD-Vi|IOMMU|page fault|DMA' | tail -20 || echo "  (none found)"
...
echo ""
echo "To reload with debug:"
echo "  sudo insmod $BUILD_DIR/mt7927.ko debug_regs=1"
echo ""
